...
@forward WrappedEnv.env RLBase.DynamicStyle, RLBase.get_current_player, RLBase.get_action_space, RLBase.get_observation_space, RLBase.render, RLBase.reset!, Random.seed!
